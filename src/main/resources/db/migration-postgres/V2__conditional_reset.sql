-- One-time conditional reset + recreate. Controlled by placeholder: ${RESET_SCHEMA}
DO $block$
BEGIN
  IF '${RESET_SCHEMA}' = 'true' THEN
    ...
    RAISE NOTICE 'Recreating baseline schema…';

    -- === baseline matching your entities ===
    ...
    -- one primary image per device (partial unique)
